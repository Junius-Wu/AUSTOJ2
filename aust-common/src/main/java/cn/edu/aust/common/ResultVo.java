...
public enum  ResultVo {
    OK(0,"success"),CODE_ERROR(1,"验证码错误"),LOGIN_ERROR(2,"用户名或密码错误"),USER_DEFUNCT(3,"用户已被冻结"),
    USER_LOCKED(4,"用户已被锁定"), USER_LOCKED_FOREVER(5,"用户已被锁定,请联系管理员解锁"),USERNAME_EXIST(6,"用户名已存在"),
    ...
    ,PROBLEM_NOT_EXIST(11,"题目不存在,请问你这是哪找的题目?"),NOT_LOGIN(12,"用户未登录");
